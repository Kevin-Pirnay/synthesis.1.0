...
{
    private readonly __center_choose_root_anim : Vector<3> = Vector_.new([window.innerWidth / 2, window.innerHeight * 3/4, 0]);
    ...
    {
        return Vector_.new([window.innerWidth / 2, window.innerHeight, 0]);
    }
